...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        List<DropBeanFlag> dropBeans = initDatas();

        //方法一
        dropDownButton.attach(this, dropBeans, 0.5F, layoutMask);
...
//
//                    dropAdapter.addOnItemClickListener(new DropAdapter.OnClickListener() {
//                        @Override
